    ...
    <div id="main-wrapper">
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown mega-dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="h1-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      <strong>Demos (Pro version)</strong> <i class="fa fa-angle-down m-l-5"></i>
                                    </a>
                                    <ul class="b-none dropdown-menu animated fadeInUp p-0">
                                        <li><a class="dropdown-item p-0" href="https://wrappixel.com/demos/ui-kit/wrapkit/wrapkit/iframe.html"><img src="images/landingpage/demos-wrapkit-lite-pro.jpg" alt="wrapkit"/></a></li>
                                    </ul>
                                  </li>
                                <li class="nav-item dropdown mega-dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="h1-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      <strong>Pro Sections</strong> <i class="fa fa-angle-down m-l-5"></i>
                                    </a>
                                    <ul class="b-none dropdown-menu animated fadeInUp p-0">
                                        <li><a class="dropdown-item p-0" href="https://wrappixel.com/demos/ui-kit/wrapkit/wrapkit/iframe.html"><img src="images/landingpage/prod-sections-dropdown.jpg" alt="wrapkit"/></a></li>
                                    </ul>
                                  </li>
                            </ul>
                            <div class="act-buttons">
                                 <a href="https://wrappixel.com/templates/wrapkit/" class="btn btn-danger-gradiant font-14">Upgrade To Pro</a>
                            </div>
                        </div>
                    </nav>
                </div>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-8 col-md-6 align-self-center text-center" data-aos="fade-up" data-aos-duration="1200">
                                ...
                                <h4 class="subtitle font-light">Free Bootstrap 4 UI Kit with<br/> Lots of Ready to Use Sections</h4> 
                ...
                <div class="header1 po-relative">
                    <div class="container">
                        ...
                        <nav class="navbar navbar-expand-lg h1-nav">
                          <a class="navbar-brand" href="#"><img src="images/logos/green-logo.png" alt="wrapkit" /></a>
                ...
                <div class="header1 po-relative bg-dark">
                    <div class="container">
                        ...
                        <nav class="navbar navbar-expand-lg h2-nav">
                          <a class="navbar-brand" href="#"><img src="images/logos/white-logo.png" alt="wrapkit" /></a>
                          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#header1" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
                            <span class="ti-menu"></span>
                          </button>
                          ...
                          <div class="collapse navbar-collapse" id="header1">
                            <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                             ...
                             <li class="nav-item"><a class="nav-link" href="#">Freebies</a></li>
                             <li class="nav-item"><a class="btn btn-outline-info" href="#">Hire Me</a></li>
                            </ul>
                          </div>
                        </nav>
                        <!-- End Header 1 code -->
                ...
                <!-- Static Slider 10  -->
                <!-- ============================================================== -->
                <div class="static-slider10" style="background-image:url(images/static-slider/slider10/img1.jpg)">
                    <div class="container">
                        <!-- Row  -->
                        <div class="row justify-content-center ">
                            <!-- Column -->
                ...
                <div class="bg-light">
                    <section>
                        <div id="banner1" class="banner spacer" style="background-image:url(images/form-banners/banner1/banner-bg.jpg);">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-lg-6 align-self-center ml-auto" data-aos="fade-left" data-aos-duration="1500">
                                        <img src="images/form-banners/banner1/banner-img.png" alt="We are Digital Agency" class="img-fluid" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="card-body d-flex no-block">
                                                <div class="m-r-20"><img src="images/features/feature13/img1.jpg" width="70" class="rounded" /></div>
                                                <div>
                            ...
                            <div class="col-lg-6" data-aos="flip-right" data-aos-duration="1200">
                                <div class="card">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="card-body d-flex no-block">
                                                <div class="m-r-20"><img src="images/features/feature13/img2.jpg" width="70" class="rounded" /></div>
                                                <div>
                                                    <h5 class="font-medium">Make your website in no-time with us.</h5>
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="1200">
                                <div class="card">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="card-body d-flex no-block">
                                                <div class="m-r-20"><img src="images/features/feature13/img3.jpg" width="70" class="rounded" /></div>
                                                <div>
                                                    <h5 class="font-medium">Make your website in no-time with us.</h5>
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-6" data-aos="zoom-in" data-aos-duration="1200">
                                <div class="card">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="card-body d-flex no-block">
                                                <div class="m-r-20"><img src="images/features/feature13/img4.jpg" width="70" class="rounded" /></div>
                                                <div>
                                                    <h5 class="font-medium">Make your website in no-time with us.</h5>
                                                </div>
                                            </div>
                ...
                <div class="spacer ">
                    <div class="container feature30">
                        <div class="row">
                            <div class="col-lg-10"><img src="images/features/feature30/img1.jpg" class="rounded img-responsive" alt="wrappixel" /></div>
                    ...
                    <div class="container">
                        ...
                        <div class="row m-t-30">
                            ...
                            <div class="col-lg-3 m-b-30">
                                    <!-- Row -->
                                    <div class="row no-gutters">
                                        <div class="col-md-12 pro-pic" style="background:url(images/team/t2.jpg) center center no-repeat / cover">
                                            <div class="card-img-overlay">
                                                <ul class="list-inline">    
                                                    <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                                                    <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>   
                            ...
                            <div class="col-lg-3 m-b-30">
                                    <!-- Row -->
                                    <div class="row no-gutters">
                                        <div class="col-md-12 pro-pic" style="background:url(images/team/t3.jpg) center center no-repeat / cover">
                                            <div class="card-img-overlay">
                                                <ul class="list-inline">    
                                                    <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                                                    <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>   
                            ...
                            <div class="col-lg-3 m-b-30">
                                    <!-- Row -->
                                    <div class="row no-gutters">
                                        <div class="col-md-12 pro-pic" style="background:url(images/team/t4.jpg) center center no-repeat / cover">
                                            <div class="card-img-overlay">
                                                <ul class="list-inline">    
                                                    <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                                                    <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>   
                        ...
                        <div class="row m-t-40">
                            ...
                            <div class="col-md-4">
                                <div class="card" data-aos="flip-left" data-aos-duration="1200">
                                    <a href="#"><img class="card-img-top" src="images/blog/blog-home/img3.jpg" alt="wrappixel kit"></a>
                            ...
                            <div class="col-md-4">
                                <div class="card" data-aos="flip-up" data-aos-duration="1200">
                                    <a href="#"><img class="card-img-top" src="images/blog/blog-home/img2.jpg" alt="wrappixel kit"></a>
                                    <div class="date-pos bg-info-gradiant">Oct<span>23</span></div>
                            ...
                            <div class="col-md-4">
                                <div class="card" data-aos="flip-right" data-aos-duration="1200">
                                    <a href="#"><img class="card-img-top" src="images/blog/blog-home/img1.jpg" alt="wrappixel kit"></a>
                                    <div class="date-pos bg-info-gradiant">Oct<span>23</span></div>
                    ...
                    <div class="container">
                        <div class="row justify-content-center wrap-feature49-box">
                            <div class="col-md-10 col-lg-7 text-center" data-aos="fade-up">
                                ...
                                <a href="javascript:void(0)" class="m-b-20"><img src="images/features/feature48/app-strore.png" /></a>
                                <a href="javascript:void(0)" class="m-b-20"><img src="images/features/feature48/play-store.png" /></a>
                            </div>
                        </div>
                    </div>
                </div>
