                    ...
                    <div style="height:20vh"></div>
                        <div class="col-xl-8 p-5">
                            ...
                            {{-- <form class="row pr-5" action="KelasController@store" method="POST"> --}}
                                {!! Form::open(['action'=>'KelasController@store', 'method' => 'POST', 'class'=> 'row pr-5']) !!}
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <textarea name="deskripsi" class="form-control" id="DESKRIPSI KELAS" cols="30" rows="10"></textarea>
                                </div>
